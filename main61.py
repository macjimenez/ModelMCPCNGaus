from load_data_ddi3 import load_data, sentence_split_for_pcnn
from model6 import CNN, MCCNN, BILSTM, PCNN, MC_PCNN, MC_PCNN_ATT
from ddi_conf6 import param  # Get hyperparameter informaction
import numpy as np
