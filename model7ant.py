...
class CNN(object):
    def __init__(self, cfg, vocb, d1_vocb, d2_vocb):
        ...
        self.GaussNoise = cfg.GaussNoise
        self.build_model()
...
### Aumento codigo antes de l activacion ruido gausiano
        self.fc_l  = GaussianNoise(stddev=self.GaussNoise)(self.fc_l)
    ...
    def write_hyperparam(self):
        ...
        log_str_2 = "k_lst: {} | nb_filters: {} | emb_dim: {} | pos_dim: {} | sent_len: {} | dropout: {}  | GaussNoise: {}  | L2: {} ".format(k_lst_str, self.nb_filters,
                                                                                                                 self.emb_dim, self.pos_dim,
                                                                                                                 self.max_sent_len, self.dropout_rate , self.GaussNoise, self.reg_coef_dense)
...
class BILSTM(CNN):
    ...
    def write_hyperparam(self):
        ...
        log_str_2 = "rnn_dim: {} | emb_dim: {} | pos_dim: {} | sent_len: {} | dropout: {} | GaussNoise: {} | L2: {} ".format(self.rnn_dim, self.emb_dim, self.pos_dim,
                                                                                                  self.max_sent_len, self.dropout_rate, self.GaussNoise, self.reg_coef_dense)
        return log_str_1, log_str_2
...
### Aumento codigo antes de l activacion ruido gausiano
        self.rnn_l   = GaussianNoise(stddev=self.GaussNoise)(self.rnn_l)
...
### Aumento codigo antes de l activacion ruido gausiano
        self.concat_l  = GaussianNoise(stddev=self.GaussNoise)(self.concat_l)
