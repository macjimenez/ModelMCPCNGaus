...
from keras.layers import Dense, Conv1D, MaxPool1D, Flatten, Dropout, Embedding, Input, concatenate, add, Bidirectional, LSTM, BatchNormalization, \
    GlobalMaxPool1D, Activation, SeparableConv1D, Reshape, Conv2D, GlobalMaxPool2D, ZeroPadding2D,  GaussianNoise
...
class CNN(object):
    ...
    def add_embedding_layer(self):
        ...
        # Concatenation
        self.w_emb = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(self.w_emb)
        self.d1_emb = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(self.d1_emb)
        self.d2_emb = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix))(self.d2_emb)
...
###    Aumento de codigo
            conv_l = Bidirectional(LSTM(self.rnn_dim , dropout=self.dropout_rate,
                                        recurrent_dropout=self.dropout_rate, return_sequences=True))(conv_l)
    ...
    def train(self, train_data, dev_data):
        ...
        # Write log
        logging.basicConfig(filename=os.path.join(result_dir, 'result5.log'),
        ...
        # Training
        self.history = self.model.fit(x=[tr_sentences2idx, tr_d1_pos_lst, tr_d2_pos_lst], y=tr_y, epochs=self.nb_epoch,
    ...
    def evaluate(self, test_data):
        ...
        ## Graficos
        ## INICIO
        print("MCJH 1 INICIO GRAFICOS")
        from keras.utils import plot_model

        #plot_model(self.model, to_file='model_plot1.png', show_shapes=True, show_layer_names=True)
...
class MCCNN(CNN):
    ...
    def add_embedding_layer(self):
        ...
        for word_matrix in word_matrix_lst:
            ...
            w_emb  = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(w_emb)
            d1_emb = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix_lst))(d1_emb)
            d2_emb = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix_lst))(d2_emb)
            # Concatenation
...
class BILSTM(CNN):
    ...
    def add_rnn_layer(self):
        ...
        self.rnn = Bidirectional(LSTM(self.rnn_dim, dropout=self.dropout_rate,
        ...
        self.rnn_l = Bidirectional(LSTM(self.rnn_dim, dropout=self.dropout_rate,
                                        recurrent_dropout=self.dropout_rate, return_sequences=True))(self.rnn)
     
    
    
        self.rnn_l = add([self.rnn, self.rnn_l])
...
class PCNN(CNN):
    ...
    def add_embedding_layer(self):
        ...
        self.d1_emb_left   = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(self.d1_emb_left)
        self.d1_emb_mid = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix_lst))(self.d1_emb_mid)
        self.d1_emb_right = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix_lst))(self.d1_emb_right)
        ...
        self.d2_emb_left   = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(self.d2_emb_left)
        self.d2_emb_mid = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix_lst))(self.d2_emb_mid)
        self.d2_emb_right = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix_lst))(self.d2_emb_right)
...
###    Aumento de codigo
            conv_l_left = Bidirectional(LSTM(self.rnn_dim , dropout=self.dropout_rate,
                                        recurrent_dropout=self.dropout_rate, return_sequences=True))(conv_l_left)

            conv_l_mid = Bidirectional(LSTM(self.rnn_dim , dropout=self.dropout_rate,
                                        recurrent_dropout=self.dropout_rate, return_sequences=True))(conv_l_mid)

            conv_l_right = Bidirectional(LSTM(self.rnn_dim , dropout=self.dropout_rate,
                                        recurrent_dropout=self.dropout_rate, return_sequences=True))(conv_l_right)
    ...
    def train(self, train_data, dev_data):
        ...
        # Training
        history = self.model.fit(x=[tr_sent_left, tr_sent_mid, tr_sent_right, tr_d1_left, tr_d1_mid, tr_d1_right,
...
class MC_PCNN(PCNN):
    ...
    def add_embedding_layer(self):
        ...
        for word_matrix in word_matrix_lst:
            ...
            d1_emb_left   = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(d1_emb_left)
            d1_emb_mid = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix_lst))(d1_emb_mid)
            d1_emb_right = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix_lst))(d1_emb_right)

            d2_emb_left   = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(d2_emb_left)
            d2_emb_mid = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix_lst))(d2_emb_mid)
            d2_emb_right = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix_lst))(d2_emb_right)
            ...
            w_emb_left   = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(w_emb_left)
            w_emb_mid = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix_lst))(w_emb_mid)
            w_emb_right = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix_lst))(w_emb_right)
