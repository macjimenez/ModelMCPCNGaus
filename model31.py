...
###    Aumento de codigo
    ...
    def train(self, train_data, dev_data):
        ...
        # Write log
        logging.basicConfig(filename=os.path.join(result_dir, 'result3.log'),
...
class PCNN(CNN):
    ...
    def add_embedding_layer(self):
        ...
        self.d1_emb_mid = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(self.d1_emb_mid)
        self.d1_emb_right = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix))(self.d1_emb_right)
        ...
        self.d2_emb_mid = GaussianNoise(0.1, input_shape=(None, self.max_sent_len, word_matrix))(self.d2_emb_mid)
        self.d2_emb_right = GaussianNoise(0.1, input_shape=(None, self.max_sent_len,word_matrix))(self.d2_emb_right)
