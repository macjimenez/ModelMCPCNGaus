...
from model8 import CNN, MCCNN, BILSTM, PCNN, PCNNVar, MC_PCNN, MC_PCNN_ATT
from ddi_conf8 import param  # Get hyperparameter informaction
import numpy as np
...
if __name__ == '__main__':
    ...
    if cfg.train_mode.lower() == 'pcnn' or cfg.train_mode.lower() == 'pcnnvar' or cfg.train_mode.lower() == 'mcpcnn' or cfg.train_mode.lower() == 'mcpcnn_att':
        ...
        elif cfg.train_mode.lower() == 'pcnnvar':
            model = PCNNVar(cfg, vocb, d1_vocb, d2_vocb)
