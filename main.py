from load_data_ddi9 import load_data, sentence_split_for_pcnn
from model import CNN, MCCNN, PCNN, MC_PCNN
from ddi_conf import param  # Get hyperparameter informaction
import numpy as np
